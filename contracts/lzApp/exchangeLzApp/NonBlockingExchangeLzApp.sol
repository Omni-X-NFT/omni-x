 ...
 */
abstract contract NonblockingExchangeLzApp is ExchangeLzApp {
    constructor(address _endpoint, address _owner) ExchangeLzApp(_endpoint, _owner) {}
