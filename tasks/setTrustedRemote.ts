...
export const setTrustedRemote = async function (taskArgs: any, hre: any) {
  ...
  try {
    ...
    const tx = await (await contractInstance.setTrustedRemote(dstChainId, trustedRemote, { gasPrice: 80000000000, maxFeePerGas: 1600000000000, maxPriorityFeePerGas: 30000000000 })).wait()
