...
async function main () {
  ...
  const advancedONFT1155Gasless = await AdvancedONFT1155Gasless.deploy(lzEndpoints.arbitrumGoerli[0], tokenUri, tokenUri, tax, owner.address, usdcaddress, maxTokensPerMint, lzEndpoints.arbitrumGoerli[1])
